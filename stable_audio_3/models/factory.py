...
def create_model_from_config(model_config):
    ...
    if model_type == 'autoencoder':
        ...
        from .captioner import create_captioner_from_config
        return create_captioner_from_config(model_config)
    else:
...
def create_pretransform_from_config(pretransform_config, sample_rate):
    ...
    elif pretransform_type == "householder":
        from .pretransforms import HouseholderPretransform

        householder_config = pretransform_config["config"]
        pretransform = HouseholderPretransform(**householder_config)
    elif pretransform_type == "lifting":
        from .pretransforms import LiftingPretransform

        lifting_config = pretransform_config["config"]
        pretransform = LiftingPretransform(**lifting_config)
    elif pretransform_type == "complex_stft":
        from .pretransforms import ComplexSTFTPretransform

        complex_stft_config = pretransform_config["config"]
        pretransform = ComplexSTFTPretransform(**complex_stft_config)
